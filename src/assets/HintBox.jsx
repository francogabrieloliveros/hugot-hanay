    ...
    >
      <div className="w-[90dvw] max-w-[660px] rounded-4xl border-3 border-black bg-white p-8 shadow-[3px_5px_0_0_black]">
        ...
        <div className="flex flex-col">
          <span className="group relative my-4 inline-block w-53 cursor-pointer transition-all active:opacity-50">
            <p
          ...
          <span className="group relative my-4 inline-block w-58 cursor-pointer transition-all active:opacity-50">
            <p
              className="oleo relative z-10 text-2xl"
              onClick={() => {
                setShow(false);
          ...
          <span className="group relative my-4 inline-block w-55 cursor-pointer transition-all active:opacity-50">
            <p
              className="oleo relative z-10 text-2xl"
              onClick={() => {
                setShow(false);
          ...
          <span className="group relative my-4 inline-block w-45 cursor-pointer transition-all active:opacity-50">
            <p
              className="oleo relative z-10 text-2xl"
              onClick={() => {
                setRevealed((prev) => {
